...
function Level(plan) {
  ...
  this.Lava = this.actors.filter(function(actor) {
...
function LavaOff(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.2, 0.1));
  this.size = new Vector(0.6, 0.6);
  // Make it go back and forth in a sine wave.
  this.wobble = Math.random() * Math.PI * 2;
}
LavaOff.prototype.type = "lavaoff";
...
var wobbSpeed = 2, wobbDist = 0.15;

LavaOff.prototype.act = function(step) {
